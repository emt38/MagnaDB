...
namespace MagnaDB.MySQL
{
    ...
    public static class ModelExtensions
    {
        ...
        /// <param name="innerModelTypes">Class types of the forign properties you want to load</param>
        /// <returns>Returns an IEnumerable of the class type with the resulting foreign properties</returns>
        public static T LoadRelationships<T>(this T result, MySqlConnection connection, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// <param name="innerModelTypes">Class types of the forign properties you want to load</param>
        /// <returns>Returns an IEnumerable of the class type with the resulting foreign properties</returns>
        public static T LoadRelationships<T>(this T result, MySqlTransaction trans, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// <param name="innerModelTypes">Class types of the forign properties you want to load</param>
        /// <returns>Returns an IEnumerable of the class type with the resulting foreign properties</returns>
        public static async Task<T> LoadRelationshipsAsync<T>(this T result, MySqlConnection connection, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// <param name="innerModelTypes">Class types of the forign properties you want to load</param>
        /// <returns>Returns an IEnumerable of the class type with the resulting foreign properties</returns>
        public static async Task<T> LoadRelationshipsAsync<T>(this T result, MySqlTransaction trans, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// (through properties decored with the ForeignRelation Attribute)</param>
        /// <returns>Returns a List of the class type with the resulting foreign properties</returns>
        public static List<T> LoadRelationships<T>(this List<T> result, MySqlConnection connection, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// (through properties decored with the ForeignRelation Attribute)</param>
        /// <returns>Returns a List of the class type with the resulting foreign properties</returns>
        public static List<T> LoadRelationships<T>(this List<T> result, MySqlTransaction trans, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// (through properties decored with the ForeignRelation Attribute)</param>
        /// <returns>Returns a List of the class type with the resulting foreign properties</returns>
        public static async Task<List<T>> LoadRelationshipsAsync<T>(this List<T> result, MySqlConnection connection, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// (through properties decored with the ForeignRelation Attribute)</param>
        /// <returns>Returns a List of the class type with the resulting foreign properties</returns>
        public static async Task<List<T>> LoadRelationshipsAsync<T>(this List<T> result, MySqlTransaction trans, params Type[] innerModelTypes) where T : ViewModel<T>, new()
        {
        ...
        /// <returns>Returns a boolean value indicating whether the insertion was successful or not</returns>
        public static bool GroupInsert<T>(this IEnumerable<T> tableModels, MySqlConnection connection) where T : TableModel<T>, new()
        {
        ...
        /// <param name="connection">An open MySqlConnection to execute the Insert statement against</param>
        /// <returns>Returns a boolean value indicating whether the insertion was successful or not</returns>
        public static async Task<bool> GroupInsertAsync<T>(this IEnumerable<T> tableModels, MySqlConnection connection) where T : TableModel<T>, new()
        {
